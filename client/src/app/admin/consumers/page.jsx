...
//         setSuccess(`✅ Token generation started for ${name}! Transaction sent to blockchain.`);
...
//         setSuccess(`✅ ${categoryName} token generation started! Transaction sent to blockchain.`);
...
//         setSuccess(`✅ Monthly token generation started! Transaction sent to blockchain.`);
...
//                 disabled={refreshing}
//                 className="px-4 py-3 bg-green-600 hover:bg-green-700 text-white rounded-md transition-colors flex items-center gap-2 justify-center disabled:opacity-50"
//               >
...
//                 disabled={refreshing}
//                 className="px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors flex items-center gap-2 justify-center disabled:opacity-50"
//               >
//                 <Package className="h-4 w-4" />
//                 Generate APL Tokens
//               </button>
...
//                 disabled={refreshing}
//                 className="px-4 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-md transition-colors flex items-center gap-2 justify-center disabled:opacity-50"
//               >
...
//                       disabled={refreshing}
//                       className="px-3 py-1 text-sm bg-green-600 hover:bg-green-700 text-white rounded-md transition-colors flex items-center gap-1 disabled:opacity-50"
//                     >
...
//           <p>Data fetched directly from blockchain • Contract: 0xB58Ec9EC4a0a8cfFEA29db6099f094a079919c80</p>
