...
export default function ShopkeeperDebugPage() {
    ...
    try {
      ...
      if (blockchainData.success) {
        ...
        console.log(
          ...
          blockchainData.shopkeepers?.length || 0
        );
      }
    } catch (error) {
  ...
  return (
    <AdminLayout>
      <div className="max-w-7xl mx-auto mt-6 mb-12 space-y-6">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Shopkeeper Debug Dashboard
          </h1>
          <p className="text-gray-600">
            Compare database vs blockchain shopkeeper data
          </p>
        </div>
                ...
                <div className="space-y-3 text-red-700">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    <li>
                      You have{" "}
                      <strong>
                        {databaseShopkeepers.length} shopkeepers in database
                      </strong>
                    </li>
                    <li>
                      But{" "}
                      <strong>0 shopkeepers registered on blockchain</strong>
                    </li>
                    <li>
                      Consumer approval fails because smart contract checks
                      blockchain registration
                    </li>
                    <li>
                      Contract validation:{" "}
                      <code>s.shopkeepers_[shopkeeper]</code> returns{" "}
                      <code>false</code>
                    </li>
                  </ul>
                  ...
                  <div className="mt-4 p-3 bg-red-100 rounded">
                    ...
                    <p className="text-sm">
                      Register shopkeepers on blockchain first, then they'll
                      appear in consumer approval dropdown.
                    </p>
                    <div className="mt-2">
                      <a
            ...
            {blockchainShopkeepers.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-red-600 font-medium">
                  No shopkeepers registered on blockchain
                </p>
                <p className="text-sm text-gray-500 mt-2">
                  This is why consumer approval fails with "Invalid shopkeeper"
                  error
                </p>
                <div className="mt-4">
        ...
        <div className="flex gap-4 justify-center">
          ...
          <a href="/admin/consumer-requests">
            <Button variant="outline">Consumer Requests</Button>
          </a>
        </div>
      </div>
    </AdminLayout>
