      ...
      if (response.ok) {
        ...
        if (data.success && Array.isArray(data.data)) {
          ...
          const mappedShopkeepers = data.data.map((shopkeeper) => ({
            walletAddress:
              shopkeeper.shopkeeperAddress || shopkeeper.walletAddress,
          ...
          console.log(
            `✅ Found ${mappedShopkeepers.length} shopkeepers from blockchain`
          );
        } else {
        ...
        console.error(
          "❌ Failed to fetch shopkeepers, status:",
          response.status
        );
        setShopkeepers([]);
      }
        ...
        toast({
          ...
          description: (
            <div className="space-y-2">
              <div>
                Consumer {selectedRequest.name} has been registered on
                blockchain
              </div>
              {result.confirmed ? (
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Review and approve consumer signup requests
            </p>
          </div>
              ...
              <Card key={request._id} className="border-l-4 border-l-blue-500">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-4">
                    <Dialog
                      open={dialogOpen && selectedRequest?._id === request._id}
                      onOpenChange={(open) => {
                        if (!open) {
                          setDialogOpen(false);
                          setSelectedRequest(null);
                      ...
                      <DialogContent className="sm:max-w-[500px]">
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            ...
                            <strong>{request.name}</strong> by selecting a
                            shopkeeper and category.
                          </DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="space-y-6 py-4">
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="shopkeeper">
                              Assign Shopkeeper *
                            </Label>
                            <Select
                              value={selectedShopkeeper}
                              onValueChange={setSelectedShopkeeper}
                            >
                              <SelectTrigger>
                              ...
                              <SelectContent>
                                {shopkeepers.length === 0 ? (
                                  ...
                                  shopkeepers.map((shopkeeper) => (
                                    <SelectItem
                                      key={shopkeeper.walletAddress}
                                      value={shopkeeper.walletAddress}
                                    >
                                      <div className="flex flex-col">
                                        ...
                                        <span className="text-xs text-gray-500">
                                          {shopkeeper.area} •{" "}
                                          {shopkeeper.walletAddress.slice(0, 6)}
                                          ...
                                          {shopkeeper.walletAddress.slice(-4)}
                                        </span>
                                      </div>
                                    </SelectItem>
                                  ))
                          ...
                          <div className="flex items-start gap-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                            ...
                            <div className="text-sm">
                              ...
                              <p className="text-yellow-700 mt-1">
                                This will register the consumer on the Polygon
                                Amoy blockchain. Make sure the details are
                                correct as this cannot be easily undone.
                              </p>
                            </div>
                          </div>
                        </div>
